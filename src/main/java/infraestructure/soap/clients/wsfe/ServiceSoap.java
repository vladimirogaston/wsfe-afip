...
public interface ServiceSoap {
	 ...
	 * @param feCAEReq
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.FECAEResponse
	 */
	...
	public FECAEResponse fecaeSolicitar(
			@WebParam(name = "Auth", targetNamespace = "http://ar.gov.afip.dif.FEV1/") FEAuthRequest auth,
			@WebParam(name = "FeCAEReq", targetNamespace = "http://ar.gov.afip.dif.FEV1/") FECAERequest feCAEReq);
	 ...
	 * 
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.FERegXReqResponse
	 */
	 ...
	 * 
	 * @return returns fev1.dif.afip.gov.ar.DummyResponse
	 */
	 ...
	 * @param auth
	 * @param ptoVta
	 * @return returns fev1.dif.afip.gov.ar.FERecuperaLastCbteResponse
	 */
	...
	public FERecuperaLastCbteResponse feCompUltimoAutorizado(
			@WebParam(name = "Auth", targetNamespace = "http://ar.gov.afip.dif.FEV1/") FEAuthRequest auth,
			@WebParam(name = "PtoVta", targetNamespace = "http://ar.gov.afip.dif.FEV1/") int ptoVta,
			@WebParam(name = "CbteTipo", targetNamespace = "http://ar.gov.afip.dif.FEV1/") int cbteTipo);
	 ...
	 * @param auth
	 * @param feCompConsReq
	 * @return returns fev1.dif.afip.gov.ar.FECompConsultaResponse
	 */
	...
	public FECompConsultaResponse feCompConsultar(
			@WebParam(name = "Auth", targetNamespace = "http://ar.gov.afip.dif.FEV1/") FEAuthRequest auth,
			@WebParam(name = "FeCompConsReq", targetNamespace = "http://ar.gov.afip.dif.FEV1/") FECompConsultaReq feCompConsReq);
	 ...
	 * @return returns fev1.dif.afip.gov.ar.FECAEAResponse
	 */
	...
	public FECAEAResponse fecaeaRegInformativo(
			@WebParam(name = "Auth", targetNamespace = "http://ar.gov.afip.dif.FEV1/") FEAuthRequest auth,
			@WebParam(name = "FeCAEARegInfReq", targetNamespace = "http://ar.gov.afip.dif.FEV1/") FECAEARequest feCAEARegInfReq);
	 ...
	 * @param periodo
	 * @param orden
	 * @return returns fev1.dif.afip.gov.ar.FECAEAGetResponse
	 */
	...
	public FECAEAGetResponse fecaeaSolicitar(
			@WebParam(name = "Auth", targetNamespace = "http://ar.gov.afip.dif.FEV1/") FEAuthRequest auth,
			@WebParam(name = "Periodo", targetNamespace = "http://ar.gov.afip.dif.FEV1/") int periodo,
			@WebParam(name = "Orden", targetNamespace = "http://ar.gov.afip.dif.FEV1/") short orden);
	 ...
	 * @param auth
	 * @param ptoVta
	 * @return returns fev1.dif.afip.gov.ar.FECAEASinMovConsResponse
	 */
	...
	public FECAEASinMovConsResponse fecaeaSinMovimientoConsultar(
			@WebParam(name = "Auth", targetNamespace = "http://ar.gov.afip.dif.FEV1/") FEAuthRequest auth,
			@WebParam(name = "CAEA", targetNamespace = "http://ar.gov.afip.dif.FEV1/") String caea,
			@WebParam(name = "PtoVta", targetNamespace = "http://ar.gov.afip.dif.FEV1/") int ptoVta);
	 ...
	 * @param auth
	 * @param ptoVta
	 * @return returns fev1.dif.afip.gov.ar.FECAEASinMovResponse
	 */
	 ...
	 * @param monId
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.FECotizacionResponse
	 */
	...
	public FECotizacionResponse feParamGetCotizacion(
			@WebParam(name = "Auth", targetNamespace = "http://ar.gov.afip.dif.FEV1/") FEAuthRequest auth,
			@WebParam(name = "MonId", targetNamespace = "http://ar.gov.afip.dif.FEV1/") String monId);
	 ...
	 * 
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.FETributoResponse
	 */
	 ...
	 * 
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.MonedaResponse
	 */
	 ...
	 * 
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.IvaTipoResponse
	 */
	 ...
	 * 
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.OpcionalTipoResponse
	 */
	 ...
	 * 
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.ConceptoTipoResponse
	 */
	 ...
	 * 
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.FEPtoVentaResponse
	 */
	 ...
	 * 
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.CbteTipoResponse
	 */
	 ...
	 * 
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.DocTipoResponse
	 */
	 ...
	 * 
	 * @param auth
	 * @return returns fev1.dif.afip.gov.ar.FEPaisResponse
	 */
